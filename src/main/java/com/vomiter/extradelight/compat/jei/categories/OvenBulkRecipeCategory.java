...
public class OvenBulkRecipeCategory implements IRecipeCategory<OvenRecipe> {
	public static final RecipeType<OvenRecipe> TYPE = RecipeType.create(ExtraDelight.MOD_ID, "oven_bulk", OvenRecipe.class);
	private final IDrawable background;
	private final Component localizedName;
	private final IDrawable icon;

	public OvenBulkRecipeCategory(IGuiHelper guiHelper) {
	...
	@Override
	public void setRecipe(@NotNull IRecipeLayoutBuilder builder, OvenRecipe recipe, @NotNull IFocusGroup focuses) {
