...
public class DoughShapingMenu extends AbstractContainerMenu {
	...
	private static SimpleContainer createRecipeInput(Container container) {
		return new SimpleContainer(container.getItem(0));
	}
	...
	void setupResultSlot() {
		if (!this.recipes.isEmpty() && this.isValidRecipeIndex(this.selectedRecipeIndex.get())) {
			DoughShapingRecipe recipe = this.recipes.get(this.selectedRecipeIndex.get());
			ItemStack itemstack = recipe.assemble(createRecipeInput(this.container),
