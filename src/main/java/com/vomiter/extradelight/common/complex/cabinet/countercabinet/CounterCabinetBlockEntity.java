...
public class CounterCabinetBlockEntity extends ExtraDelightCapabilityBlockEntity implements MenuProvider {
    ...
    public AbstractContainerMenu createMenu(int windowId, Inventory playerInventory,
                                            Player playerEntity) {
        return new CounterCabinetMenu(windowId, playerInventory, this);
    }
